		...
		START2:
			...
			if (x == 1)
			{
				...
				while (1)
				{
					...
					cout << "\n\t\t2.Display Doctor's Information\n";
					cout << "\n\t\t3.Delete Doctor's Information\n";
					cout << "\n\t\t4.Number Of Doctors In The Hospital\n";
					cout << "\n\t\t5.Clear All The Information In The Database\n";
					cout << "\n\t\t6.Display The Details Of All The Doctors\n";
					cout << "\n\t\t7.Exit\n";
					cout << "\n********************************************************************************\n";
					int opt;
		...
		START4:
			...
			if (x == 1)
			{
				...
				while (1)
				{
					...
					cout << "\n\t\t2.Display Patient's Information\n";
					cout << "\n\t\t3.Delete Patient's Information\n";
					cout << "\n\t\t4.No.Of Patients In The Hospital\n";
					cout << "\n\t\t5.Delete All The Contents In The Database\n";
					cout << "\n\t\t6.Display The Details Of All The Patients In The Hospital\n";
					cout << "\n\t\t7.Exit\n\n";
					cout << "********************************************************************************\n";
					int opt;
					cout << "\nPlease Choose Your Choice :";
